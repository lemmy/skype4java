...
public final class OSXConnector extends Connector {
    ...
    /**
     * Block the usage of the constructor because this is a singleton. Use
     * getInstance();
     * 
     */
    ...
    protected void initialize(int timeout) throws ConnectorException {
        ...
        synchronized (object) {
            try {
                 ...
                 * object.wait(timeout); if (timeout <=
                 * System.currentTimeMillis() - start) { throw new
                 * ConnectorException("The OSX connector couldn't be initialized
                 * by timeout."); }
                 */
            } catch (Exception e) {
    ...
    protected Status connectImpl(int timeout) throws ConnectorException {
        ...
        try {
            ...
            throw new InternalError("The listener couldn't be added."); // The
                                                                        // flow
                                                                        // must
                                                                        // not
                                                                        // reach
